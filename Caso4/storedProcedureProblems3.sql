...
-- Transacción 1
BEGIN TRANSACTION;
-- Se llama un conjunto de datos posibles modificaciones
SELECT * FROM contacts WHERE contactType = 'Cliente';
-- Transacción 1 simula una espera
WAITFOR DELAY '00:00:10';
-- Se llama un conjunto de datos que pudo haber sufrido phantom read
SELECT * FROM contacts WHERE contactType = 'Cliente';
COMMIT TRANSACTION;
...
-- Transaction 1
BEGIN TRANSACTION
    EXEC UpdateExistingContact @ContactId = 1, @Name = 'John'
    -- Transaction 1 adquiere el bloqueo en el contacto con contactId = 1

    -- Esperar para simular un interbloqueo
    WAITFOR DELAY '00:00:05'

    -- Transaction 1 intenta actualizar el contacto con contactId = 2, el cual está bloqueado por Transaction 2
    EXEC UpdateExistingContact @ContactId = 2, @Name = 'Jane'
...
BEGIN TRANSACTION
    EXEC UpdateExistingContact @ContactId = 2, @Name = 'Jane'
    -- Transaction 2 adquiere el bloqueo en el contacto con contactId = 2

    -- Esperar para simular un interbloqueo
    --WAITFOR DELAY '00:00:05'

    -- Transaction 2 intenta actualizar el contacto con contactId = 1, el cual está bloqueado por Transaction 1
    EXEC UpdateExistingContact @ContactId = 1, @Name = 'John'
