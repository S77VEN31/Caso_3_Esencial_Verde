...
-- Comandos para hacer roles, usuarios y permisos mediante query
...
-- Restringir visibilidad de columnas
    -- Simplemente se mete en la tabla > propiedades > permisos > select > poner deny en la columna deseada
