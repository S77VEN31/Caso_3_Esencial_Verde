...
VALUES 
    ...
    INSERT INTO containers (manufacturerInfo, maxWeight, currentWeight)
VALUES ('Container Co.', 1000.00, 500.00),
       ('Container Inc.', 750.50, 250.25),
       ('Box Corp.', 500.00, 0.00),
       ('Bin Company', 2000.00, NULL),
       ('Crate Corp.', 1500.00, 750.00),
       ('Barrel Industries', 800.00, 400.00),
       ('Tub Co.', 1000.00, 1000.00),
       ('Chest Company', 1200.00, 600.00),
       ('Trunk Inc.', 1800.00, 900.00),
       ('Vessel Corp.', 500.00, 250.00),
       ('Jar Industries', 750.00, 375.00),
       ('Bag Co.', 1000.00, 500.00),
       ('Sack Company', 1200.00, 600.00),
       ('Packaging Inc.', 1500.00, 750.00),
       ('Container Solutions', 2000.00, 1000.00),
       ('Box & Co.', 800.00, 400.00),
       ('Bin & Barrel', 1000.00, 500.00),
       ('Crate Innovations', 500.00, 0.00),
       ('Vessel Works', 1800.00, 900.00),
       ('Jar Solutions', 750.00, 375.00),
       ('Chest Innovations', 1200.00, 600.00),
       ('Tub & Co.', 1000.00, 1000.00),
       ('Trunk Solutions', 1500.00, 750.00),
       ('Box Innovations', 2000.00, NULL),
       ('Container Works', 800.00, 400.00),
       ('Bin & Co.', 1000.00, 500.00),
       ('Crate Solutions', 1200.00, 600.00),
       ('Vessel Innovations', 1500.00, 750.00),
       ('Jar & Co.', 500.00, 250.00),
       ('Chest Works', 1800.00, 900.00);