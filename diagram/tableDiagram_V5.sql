...
CREATE TABLE recyclableWasteSale (
    ...
    FOREIGN KEY (sellerContact) REFERENCES contactsInfo(contactId),
    FOREIGN KEY (buyerContact) REFERENCES contactsInfo(contactId),
...
CREATE TABLE wasteTreatmentCostsXcountries ( 
    wasteTreatmentCostId INT NOT NULL,
    countryId INT NOT NULL,
    cost DECIMAL(10, 2) NOT NULL,
    FOREIGN KEY (wasteTreatmentCostId) REFERENCES wasteTreatmentCosts(wasteTreatmentCostId),
